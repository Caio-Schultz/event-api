...
import dev.caioschultz.EventClean.core.usecases.create.CreateEventUseCaseImpl;
...
public class CreateEventConfig {
    ...
    @Bean
    public CreateEventUseCaseImpl createEventCase(EventRepositoryGateway gateway){
